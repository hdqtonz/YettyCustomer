...
export class EstablishmentsService {
  ...
  getEstablishmentsData(){
    return this._http.get<EstablishmentSettings>(`${Api._getEstablishmentsSetting}`)
  }

  getEstblishmentsGeneralInfo(){
    return this._http.get<Establishment>(`${Api._getEstablishmentsGeneralInfo}`)
  }

  getEstablishmentsTableInfo(tableId:string){
    return this._http.get<EstablishmentTable>(`${Api._getEstablishmentsTableInfo}/${tableId}`)
  }

  addVisitorToTable(tableId:string, reqBody:AddVisitorRequest){
    return this._http.post<AddVisitorResponse>(`${Api._addVisitorToTable}/${tableId}/visitors`, reqBody)
  }
