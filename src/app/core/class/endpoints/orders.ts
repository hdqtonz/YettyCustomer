export class orderAPIEndpoints {
   ...
   * @type {string}
   */
  static _getTableVisitorOrder: string = "establishments/{establishmentId}/tables/{tableId}/visitors/{visitorId}/order-items";
   ...
   * @type {string}
   */
  static _addOrderItem: string = "establishments/{establishmentId}/tables/{tableId}/visitors/{visitorId}/order-items";
   ...
   * @type {string}
   */
  static _modifyOrderItem: string = "establishments/{establishmentId}/tables/{tableId}/visitors/{visitorId}/order-items/{orderItemId}";
   ...
   * @type {string}
   */
  static _sendNotSentOrderItems: string = "establishments/{establishmentId}/tables/{tableId}/visitors/{visitorId}/order-items/send"
   ...
   * @type {string}
   */
  static _cancelSentOrderItem: string = "establishments/{establishmentId}/tables/{tableId}/visitors/{visitorId}/order-items/{orderItemId}/cancel"
}
